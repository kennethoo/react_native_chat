...
class Message extends Component{
    ...
    render(){
        return(
            <View style={socket.id==this.props.item.sender?styles.messageme:styles.messagfriend}>
            <View style={socket.id==this.props.item.sender?styles.boxmessage:styles.boxmessagef} >
